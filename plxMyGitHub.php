 ...
 *
 **/
class plxMyGitHub extends plxPlugin {
	...
	public function plxMotorPreChauffageBegin() {
		...
		if(\$this->get && preg_match('/^github\/?/',\$this->get)) {
			\$this->mode = 'github';
			\$this->cible = '../../plugins/plxMyGitHub/static';
	...
	public function ThemeEndHead() {
		...
		echo '<script type="text/javascript" src="'.PLX_PLUGINS.'plxMyGitHub/js/jquery.min.js"></script>'."\n";
		echo '<script type="text/javascript" src="'.PLX_PLUGINS.'plxMyGitHub/js/repo.min.js"></script>'."\n";
